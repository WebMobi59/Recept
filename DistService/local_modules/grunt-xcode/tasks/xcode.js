...
module.exports = function(grunt) {
  function executeCommand(args, silent){
    ...
    return new Promise(function(resolve, reject){
      ...
      var cmd = exec(command, {maxBuffer: 10000*1024}, function(error){
  ...
  grunt.registerMultiTask('xcode', 'Build and export Xcode projects with Grunt', function() {
    ...
    function runExportCommand(){
      ...
      if(!options.exportSigningIdentity && !options.exportProvisioningProfile) command.push('-exportWithOriginalSigningIdentity');
